  ...
  return (
    <>
      <div className="bg-[#46B0C8]">
        <div className="flex md:flex-row flex-col md:h-screen relative w-[80%] mx-auto justify-center">
          <div className="md:w-[50%] w-[80%]  md:mx-0 mx-auto md:h-[100%] h-screen flex text-white">
            <div className="m-auto w-[80%] space-y-8 backdrop-blur-md text-center font-RobotoSlab">
          ...
          <div className="md:w-[50%] w-[80%] flex h-screen ">
            <div className=" m-auto flex flex-col justify-center items-center">
              <div className="min-w-[320px] shadow-xl rounded-lg flex space-x-8">
                <img
                  className="w-[400px]"
              ...
              <a
                ...
                class="uppercase font-bold text-white bg-[#AC3318] border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded text-lg my-8 max-w-[50%] min-w-[320px] w-full text-center z-[9999]"
                rel="noreferrer"
              >
                Buy on Amazon
              </a>
            ...
            <div className="md:w-[50%] w-[100%] m-auto">
              <div className="md:w-[70%] w-[100%] m-auto space-y-16 text-md">
                ...
                <div className="text-lg text-justify">
                  ...
                  litter of puppies, but one special pup stands out from the
                  rest--a cute little Alaskan Husky who turned this story into a
                  mystery.
                </div>
              </div>
            </div>
